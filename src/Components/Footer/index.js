      ...
      <div className = "footer">
        <div className = "footer-container">
            <div className = "footer-boxes footer-boxes-one">
                ...
                <ul>
                    <li>
                          <a className="footer-email" href="mailto:support@royalbrothers.com" rel="noopener" target="_blank">
              ...
              <div className="footer-boxes footer-boxes-two">
                  ...
                  <ul>
                      <li>
                          <a className="footer-about-us" href="" rel="noopener" target="_blank">
                              About us
                        </a>
                      </li>
                      <li>
                          <a className = "footer-blog" hred = "">Blog</a>
                      </li>
                      <li>
              ...
              <div className = "footer-boxes footer-boxes-six">
                ...
                <ul>
                    <li className= "social">
                          <a className="app-store" href="https://apps.apple.com/in/app/royal-brothers-bike-rentals/id1405554590" rel="noopener" target = "_blank">
                        ...
                        />
                          ...
                          <a className="play-store" href="https://play.google.com/store/apps/details?id=com.royalbrothers&hl=en_IN" rel="noopener" target = "_blank" >
